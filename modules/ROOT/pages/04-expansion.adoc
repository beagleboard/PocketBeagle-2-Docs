[[pocketbeagle-2-expansion]]
== Expansion

[[pocketbeagle-2-pinout-diagrams]]
=== Pinout Diagrams
...
image::pinout/PocketBeagle-2-P1.svg[]

==== P2 cape header

.PocketBeagle 2 P2 Cape Header Pinout
image::pinout/PocketBeagle-2-P2.svg[]

[[pocketbeagle-2-connectors]]
=== Cape Header Connectors

Beagle cape expansion interface on PocketBeagle 2 like other Beagles is comprised of two headers P1 & P2. All signals on the expansion headers are *3.3V* unless otherwise indicated. *On some of the cape header pins on PocketBeagle 2 multiple SoC pins are shorted and only one of them should be used at a time.* Information regarding the double/shorted pins is provided in the `+pocketbeagle-2-pinout-diagrams+` above (simplified) and cape header pin tables below (detailed).
...
Each row includes the gpiochipX and pinY in the format of [.title-ref]#X Y#. You can use these values to directly control the GPIO pins with the commands shown below.
...
[width="27%",cols="50%,50%",options="header",]
|===
|Pin |P1.01
|Signal |VIN_5V
|===

[width="97%",cols="19%,31%,25%,25%",options="header",]
|===
...
[width="43%",cols="30%,38%,32%",options="header",]
|===
|Pin |P1.05 |P1.07
|BALL |AB10 |~
...
[width="96%",cols="16%,24%,20%,20%,20%",options="header",]
|===
...
[width="40%",cols="32%,34%,34%",options="header",]
|===
|Pin |P1_09 |P1_11
|BALL |AD10 |AE9
...
[width="97%",cols="15%,25%,29%,31%",options="header",]
|===
...
[width="97%",cols="15%,32%,27%,26%",options="header",]
|===
...
[width="92%",cols="17%,13%,10%,10%,15%,15%,10%,10%",options="header",]
|===
...
[width="58%",cols="24%,19%,19%,19%,19%",options="header",]
|===
|Pin |P1.22 |P1.23 |P1.24 |P1.25
|Signal |GND |AIN2 |VOUT |AIN3
|===

[width="96%",cols="16%,20%,20%,23%,21%",options="header",]
|===
...
[width="25%",cols="56%,44%",options="header",]
|===
|Pin |P1.27
|Signal |AIN4
|===

[width="87%",cols="20%,26%,28%,26%",options="header",]
|===
...
[width="90%",cols="18%,26%,30%,26%",options="header",]
|===
...
[width="88%",cols="18%,31%,25%,26%",options="header",]
|===
...
[width="96%",cols="15%,25%,20%,20%,20%",options="header",]
|===
...
[width="93%",cols="19%,29%,29%,23%",options="header",]
|===
...
[width="84%",cols="20%,32%,22%,26%",options="header",]
|===
...
[width="86%",cols="19%,27%,27%,27%",options="header",]
|===
...
[width="97%",cols="16%,28%,24%,32%",options="header",]
|===
...
[width="96%",cols="12%,17%,17%,17%,17%,20%",options="header",]
|===
|Pin |P2.12 |P2.13 |P2.14 |P2.15 |P2.16
|Signal |PWR.BTN |VOUT - VSYS |VBAT |GND |BAT.TEMP - BAT_TS
|===

[width="97%",cols="15%,31%,23%,31%",options="header",]
|===
...
[width="38%",cols="37%,28%,35%",options="header",]
|===
|Pin |P1.21 |P2.23
|Signal |GND |VDD_3V3
|===

[width="96%",cols="15%,20%,25%,20%,20%",options="header",]
|===
...
[width="41%",cols="34%,66%",options="header",]
|===
|Pin |P1.26
|Signal |RESET# - nRESET
|===

[width="97%",cols="16%,20%,32%,32%",options="header",]
|===
...
[width="97%",cols="15%,22%,32%,31%",options="header",]
|===
...
[width="88%",cols="19%,26%,31%,24%",options="header",]
|===
...
[width="73%",cols="21%,32%,47%",options="header",]
|===
|Pin |P2.35 |P2.36
|Signal |AIN5 |AIN7
|===
