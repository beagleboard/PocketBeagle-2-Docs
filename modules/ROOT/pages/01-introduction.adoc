...
|===
| |Feature
|*Processor* |https://www.ti.com/product/AM623[Texas Instruments AM6232]
...
image::components/front.jpg[PocketBeagle 2 board front components location,1240,align="center"]

.PocketBeagle 2 board front components location table
[cols="28%,72%",options="header"]
|===
|Feature |Description
|AM6232 SoC |Human-machine-interaction SoC with quad core A53 @ 1.4GHz
...
image::components/back.jpg[PocketBeagle 2 board back components location,1240,align="center"]
...
.Revision Note
====
A0 is Out-of-production w/ AM6232 SOC.
====
